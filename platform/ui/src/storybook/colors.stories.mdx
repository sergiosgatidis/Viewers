...
<div className="grid grid-cols-4 gap-4 h-auto w-full bg-primary-dark p-8 text-white">
...
<div className="grid grid-cols-4 gap-4 h-auto w-full bg-primary-dark text-white p-8">
  <div className="flex space-x-2 items-center">
